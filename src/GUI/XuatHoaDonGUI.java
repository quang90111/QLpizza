...
public class XuatHoaDonGUI extends JDialog {
    ...
    private CTHoaDonController ctHoaDonController = new CTHoaDonController();
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        hoadonController.luuHoaDon(DlgTimKhach.khachHangTimDuoc.getMaKH(), nhanVien, tongTien, "Đã thanh toán");
        ...
        for (Vector vec : dsGioHang) {
            ...
            ctHoaDonController.addCTHoaDon(maSP, soLuong, donGia, thanhTien);
        }
        btnThanhToan.setEnabled(false);
