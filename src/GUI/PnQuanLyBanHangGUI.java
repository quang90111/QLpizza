...
import Application.AppTier.Controller.HoaDonController;
import Application.AppTier.Controller.CTHoaDonController;
...
public class PnQuanLyBanHangGUI extends JPanel {
    ...
    private LoaiController loaiController = new LoaiController();
...
//                400));
    ...
    private void loadDataComboboxNhanVienBan() {
        ...
        for (int i = 0; i < cmbNhanVienBan.getItemCount(); i++) {
            ...
            if (cmbValue[0].equals(DangNhapController.taiKhoanLogin.getMaNhanVien() + "")) {
    ...
    private void loadDataTableSanPhamBan() {
        ...
        if (cmbLoaiSPBanHang.getItemCount() > 0) {
            ...
            if (loaiSP.equals("0")) {
                ...
                dssp = spController.getSanPhamTheoLoai(loaiSP);
            }
        } else {
            dssp = spController.getListSanPham();
        }
    ...
    private void xuLyXoaSPGioHang() {
        ...
        if (row > -1) {
            ...
            spController.capNhatSoLuongSP(ma, soLuong);
            loadDataTableSanPhamBan();
    ...
    private void xuLyClickTblGioHang() {
        ...
        loadAnh(spController.getAnh(ma));
    }
    ...
    private CTHoaDonController ctHDController = new CTHoaDonController();
    ...
    private void xuLyClickTblCTHoaDon() {
        ...
        if (row > -1) {
            ...
            String maSP = spController.getSanPham("" + tblCTHoaDon.getValueAt(row, 1)).getTenSP();
