...
public class PnQuanLyNhanVienGUI extends JPanel {
    ...
    private void xuLyKhoaTaiKhoan() {
        ...
        taiKhoanController.khoaTaiKhoan(txtMaNV.getText());
        loadDataTblNhanVien();
    }
    ...
    private void xuLyNhapExcel() {
        ...
        for (int i = 0; i < row; i++) {
            ...
            nhanVienController.nhapExcel(ho, ten, gioiTinh, chucVu);
    ...
    private void xuLyXoaNhanVien() {
        ...
        boolean flag = nhanVienController.xoaNhanVien(ma);
        if (flag) {
            nhanVienController.docDanhSach();
            loadDataTblNhanVien();
        }
    }
    ...
    private void xuLySuaNhanVien() {
        ...
        if (nhanVienController.updateNhanVien(ma, ho, ten, gioiTinh, chucVu)) {
            nhanVienController.docDanhSach();
            loadDataTblNhanVien();
        }
    }
    ...
    private void xuLyThemNhanVien() {
        ...
        String gioiTinh = cmbGioiTinh.getSelectedItem() + "";
        String chucVu = txtChucVu.getText();
        if (nhanVienController.themNhanVien(ho, ten, gioiTinh, chucVu)) {
            nhanVienController.docDanhSach();
            loadDataTblNhanVien();
        }
    }
    ...
    private void loadDataTblNhanVien() {
        ...
        for (NhanVienResource nv : dsnv) {
            ...
            vec.add(nv.getGioiTinh());
            vec.add(nv.getChucVu());
            int trangThai = taiKhoanController.getTrangThai(nv.getMaNV() + "");
            if (trangThai == 0) {
                vec.add("Khoá");
            }
            else if(trangThai == 1) {
