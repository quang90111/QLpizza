...
import Application.AppTier.Controller.ThongKeController;
...
//        pnThongKeTong.add(btn_filter);
    ...
    private CategoryDataset createDataset() {
        ...
        for (int i = 1; i <= 12; i++) {
            double value = thongKeController.getDoanhThuThang(i, Calendar.getInstance().get(Calendar.YEAR));
    ...
    private void hienThiThongKe() {
        ThongKe thongKe = thongKeController.thongKe(Integer.parseInt(cmbNam.getSelectedItem() + ""));
