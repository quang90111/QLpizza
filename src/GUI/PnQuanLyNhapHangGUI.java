...
import Application.AppTier.Controller.CTPhieuNhapController;
...
public class PnQuanLyNhapHangGUI extends javax.swing.JPanel {
    ...
    private CTPhieuNhapController ctPhieuNhapController = new CTPhieuNhapController();
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        if (xuatPhieuNhap.getCheckNhap()) {
            ...
            sanPhamController.docListSanPham();
            loadDataTableKho();
        }
    ...
    private void tblCTPhieuNhapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCTPhieuNhapMouseClicked
        ...
        String tenSP = sanPhamController.getTenSP(Integer.parseInt(tblCTPhieuNhap.getValueAt(row, 0) + ""));
